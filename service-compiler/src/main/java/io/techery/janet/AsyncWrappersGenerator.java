...
public class AsyncWrappersGenerator extends Generator<AsyncActionClass> {
    ...
    private MethodSpec createFillResponseMethod(AsyncActionClass actionClass) {
    ...
    private MethodSpec createFillPayloadMethod(AsyncActionClass actionClass) {
        ...
        if (actionClass.isBytesPayload()) {
            ...
            builder.addStatement("action.$L =  ($T) converter.fromBody(body, new $T<$T>(){}.getType())",
                    payloadField, payloadTypeName, TypeToken.class, payloadTypeName
            );
        }
        return builder.build();
    }
